...
def build_year_data(end_y, end_m, end_d):
    ...
    year, month, day = year_td, month_td, day_td-4 # Start date
...
def data_processing():
    ...
    if buildTrain == 0:
        ...
        print("x_pron, y_pron shape : ")
        print(x_pron.shape, y_pron.shape)

        # save the dataset as dataset.npz
        save_file_name = f'evaluate_{past}day_with_GT.npz'
